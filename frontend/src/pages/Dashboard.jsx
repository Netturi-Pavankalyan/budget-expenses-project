    ...
    <div className="flex min-h-screen bg-[#0a0a0f] text-white">
      ...
      <main className="flex-1 p-8 space-y-8 overflow-y-auto">
        <div className="flex justify-between items-center">
          ...
          <div className="text-sm text-gray-400 bg-[#12121a] px-4 py-2 rounded-lg border border-gray-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 bg-[#12121a] p-6 rounded-xl border border-gray-800">
              ...
              {spendData.map((item, index) => (
                <div key={index}>
                  ...
                  <div className="w-full bg-gray-800 rounded-full h-2">
                    <div 
                      className={`h-2 rounded-full ${item.amount > item.limit ? 'bg-red-500' : 'bg-blue-500'}`}
          ...
          <div className="lg:col-span-2 bg-[#12121a] p-6 rounded-xl border border-gray-800">
            ...
            {recentExpenses.map((item, index) => (
              <div key={index} className="flex items-center justify-between py-3 border-b border-gray-800 last:border-0">
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-sm font-bold text-blue-400">
                    {item.name.charAt(0)}
                  </div>
                  <div>
